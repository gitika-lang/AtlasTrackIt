...
function renderSettingsPage(){
  ...
  <div class="card">
    ...
    <div class="settings-row">
      <div><div class="srlabel">Browser Notification</div><div class="srhint">Show a system notification when a session ends and the tab isn't active${typeof Notification!=='undefined'&&Notification.permission==='denied'?' — currently blocked; enable notifications for this site in your browser settings to receive them':''}</div></div>
